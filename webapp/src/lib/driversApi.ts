...
const MOCK: DriverDetail[] = [
  {
    ...
    results: [
      ...
      driftRun("s-8990", 1 * DAY, tracks.iro, cars.s15, 13100, 13100),
  ...
  },
  {
    ...
    last_result: driftRun("s-8702", 1 * MIN, tracks.ebisu, cars.s15, 12640, 12640),
    results: [
      driftRun("s-8702", 1 * MIN, tracks.ebisu, cars.s15, 12640, 12640),
  ...
  },
  {
    ...
    last_result: raceRun("s-8551", 1 * DAY, tracks.brands, cars.gt3f, 2, 17, 83640, 30),
    results: [
      raceRun("s-8551", 1 * DAY, tracks.brands, cars.gt3f, 2, 17, 83640, 30),
