...
<template>
  <div class="relative min-w-0">
    <input
      ...
      class="min-h-11 w-full rounded-md border border-line bg-input px-3 pr-8 text-sm text-text placeholder:text-muted hover:border-accent focus:border-accent"
